class StaticQuestion:
    def __init__(self, id, question_text, option1, option2, option3, option4, correct_answer):
        self.id = id
...
# Raw questions data imported from the populate command list
questions_raw = [
    # Science & Tech
...
# Generate static question instances
QUESTIONS = [
    StaticQuestion(
        id=idx,
        question_text=q[0],
